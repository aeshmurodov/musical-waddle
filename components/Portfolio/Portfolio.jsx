...
const Portfolio = ({data}) => {
    ...
    return (
        <div className="section-box">
            <div className={`section border-radius-1 ${isLightTheme ? 'bg-dark' : 'bg-lighter'}`}>
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                            ...
                            {/* Slider Nav */}
                            <div className="mt-4">
                                <button className="swiper-portfolio-prev button-circle button-circle-lg  cursor-link" onClick={() => sliderRef.current?.slidePrev()} aria-label="Prev Slide">
                                    <i className="bi bi-arrow-left"></i>
                                </button>
                                <button className="swiper-portfolio-next button-circle button-circle-lg cursor-link" onClick={() => sliderRef.current?.slideNext()} aria-label="Prev Slide">
