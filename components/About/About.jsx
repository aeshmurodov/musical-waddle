                        ...
                        <div className="col-12 col-lg-6">
                            <div className="row">
                                <div className="col-6 text-end">
                                    <Image src={aboutData.mainData.image1} alt="img-mask" placeholder="blur" className="img-mask-2" />
                                ...
                                <div className="col-6">
                                    ...
                                    <Image src={aboutData.mainData.image2} alt="img-mask" placeholder="blur" className="img-mask-2" />

                                </div>
                            </div> {/* end row(inner) */}
                        </div>
                        <div className="col-12 col-lg-6">
                            <h6 className="title-heading mb-3">{aboutData.mainData.title1}</h6>
                            <h2 className="display-6 fw-normal mb-4">{aboutData.mainData.title2}</h2>
                                    ...
                                    <div key={index} className="col-12 col-md-6">
                                        <div className="progress-box">
                                            ...
                                            <div className="animated-progress">
                                                <div data-progress={skill.progress} style={{ width: `${skill.progress}%` }}></div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <Link className="button button-lg mt-4" href={aboutData.mainData.learnMoreUrl}>Learn More</Link>
                        </div>
                    </div> {/* end row */}
                </div> {/* end container */}
            </div>
