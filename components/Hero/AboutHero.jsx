            ...
            <div className="container">
                <div className="row g-xxl-5 align-items-center">
                    <div className="col-12 col-lg-10 col-xl-8">
                        <h1 className="display-3 fw-normal">{heroData.aboutPage.mainData.title}</h1>
                        ...
                        <div className="d-md-flex align-items-center mt-5">
                            ...
                            <div className="d-md-inline-block pt-3 pt-md-0 ps-md-4">
                                <p>We have over {heroData.aboutPage.mainData.countOfClients} clients <br className="d-lg-block" />around the world</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-xxl-4 text-xxl-end d-none d-xxl-block">
                        <Image className="img-mask-1" src={heroData.aboutPage.mainData.image} alt="image" placeholder="blur" />
                    </div>
                </div> {/* end row */}
            </div> {/* end container */}
        </div>
