		...
		<>
			...
			<div className="header with-placeholder">
				<div className="container-fluid">
					...
					{/* Menu */}
					<div ref={menuRef} className={`header-menu ${isMenuOpen ? 'show' : ''}`}>
						<ul className="nav">
										...
										<ul className="nav-dropdown">
											{menuItem.submenu.map((subItem, subIndex) => (
												<li key={subIndex} className="nav-dropdown-item">
													<Link href={subItem.link} className="nav-dropdown-link">
														{subItem.label}
													</Link>
													{subItem.navdropdown && (
														<ul className="nav-subdropdown">
															{subItem.navdropdown.map((item, index) => (
																<li key={index} className="nav-subdropdown-item">
																	<Link href={item.link} className="nav-subdropdown-link">
																		{item.label}
																	</Link>
																</li>
															))}
						...
						<button onClick={toggleMenu} id="menu-close" className="button-circle button-circle-sm">
